...
<div id="login-panel">
	<div id="login-header">
		<h1 class="text-center" style="margin-top: 15px; font-size: 28px; font-weight: bold; color: #2c3e50;">
			<i class="icon-building" style="color: #bf9b30; margin-right: 8px;"></i>{$shop_name}
		</h1>
		<div class="text-center text-muted" style="font-size: 14px; margin-bottom: 12px;">Hệ thống Quản lý Khách sạn Chuỗi</div>
		...
		{/if}
	<div id="shop-img" style="text-align: center; margin-bottom: -40px; position: relative; z-index: 10;">
		<i class="icon-user" style="font-size: 55px; line-height: 90px; color: #bf9b30; display: inline-block; width: 90px; height: 90px; background: #fff; border: 3px solid #bf9b30; border-radius: 50%; box-shadow: 0 4px 10px rgba(0,0,0,0.15);"></i>
	</div>
	...
	<div id="login-footer">
		<p class="text-center text-muted" style="margin-top: 15px;">
			&copy; {$smarty.now|date_format:"%Y"} <strong>{$shop_name}</strong> &mdash; {l s='Hệ thống Quản lý Khách sạn Chuỗi'}
		</p>
	</div>
</div>
