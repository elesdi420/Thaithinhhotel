                ...
                <div class="col-sm-12">
                    <section class="dash_links widget panel">
                        <h3><i class="icon-info-circle"></i> {l s="Hướng dẫn Vận hành Khách sạn"}</h3>
                            ...
                            <dl>
                                <dt><i class="icon-qrcode"></i> {l s="Thanh toán VietQR"}</dt>
                                <dd>{l s="Hệ thống tự động đối soát giao dịch qua mã đơn"}</dd>
                            </dl>
                            <dl>
                                <dt><i class="icon-building"></i> {l s="Đa chi nhánh"}</dt>
                                <dd>{l s="Quản lý đồng thời 3 cơ sở TP.HCM, Đà Nẵng, Hà Nội"}</dd>
                            </dl>
                            <dl>
                                <dt><i class="icon-phone"></i> {l s="Hỗ trợ nội bộ"}</dt>
                                <dd>{l s="Liên hệ Quản lý chuỗi khi cần hỗ trợ kỹ thuật"}</dd>
                            </dl>
                    </section>
                </div>
            </div>
