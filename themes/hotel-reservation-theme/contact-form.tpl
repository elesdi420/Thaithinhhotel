					...
					{foreach $hotelsInfo as $hotel}
						<div class="col-sm-6 margin-bottom-50">
							...
							<div class="hotel-address-container">
								...
								<div class="col-xs-12" style="margin-top: 12px; padding: 0 15px 15px 15px;">
									<div class="hotel-map-embed" style="border-radius: 6px; overflow: hidden; border: 1px solid #e5e5e5; box-shadow: 0 1px 4px rgba(0,0,0,0.06);">
										<iframe
											width="100%"
											height="160"
											...
											src="https://www.google.com/maps?q={if $hotel['latitude'] != 0 && $hotel['longitude'] != 0}{$hotel['latitude']},{$hotel['longitude']}{else}{$hotel['address']|escape:'url'},+{$hotel['city']|escape:'url'}{/if}&hl=vi&z=15&output=embed">
										</iframe>
									</div>
								</div>
							</div>
