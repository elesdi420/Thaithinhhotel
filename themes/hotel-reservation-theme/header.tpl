...
<html{if isset($language_code) && $language_code} lang="{$language_code|escape:'html':'UTF-8'}"{/if} {if isset($language_is_rtl) && $language_is_rtl}dir="rtl"{/if} style="{if $page_name == 'index'}height: 100%;{/if}">
	<head>
		...
		{/if}
		<meta name="generator" content="CMS Hotel PMS" />
		...
		<meta property="og:title" content="{if isset($meta_title) && $meta_title}{$meta_title|escape:'html':'UTF-8'}{else}{$shop_name|escape:'html':'UTF-8'}{/if}" />
		<meta property="og:description" content="{if isset($meta_description) && $meta_description}{$meta_description|escape:'html':'UTF-8'}{else}Hệ thống khách sạn chuỗi tiện nghi tại trung tâm TP.HCM, Đà Nẵng, Hà Nội. Đặt phòng trực tuyến giá tốt nhất.{/if}" />
		<meta property="og:url" content="{$base_dir_ssl|escape:'html':'UTF-8'}" />
		<meta property="og:site_name" content="{$shop_name|escape:'html':'UTF-8'}" />
		<meta property="og:image" content="{$logo_url|escape:'html':'UTF-8'}" />
		<meta property="og:locale" content="{if isset($language_code) && $language_code}{$language_code|escape:'html':'UTF-8'}{else}vi_VN{/if}" />

		<!-- Twitter -->
		<meta name="twitter:card" content="summary_large_image" />
		<meta name="twitter:title" content="{if isset($meta_title) && $meta_title}{$meta_title|escape:'html':'UTF-8'}{else}{$shop_name|escape:'html':'UTF-8'}{/if}" />
		<meta name="twitter:description" content="{if isset($meta_description) && $meta_description}{$meta_description|escape:'html':'UTF-8'}{else}Hệ thống khách sạn chuỗi tiện nghi tại trung tâm TP.HCM, Đà Nẵng, Hà Nội. Đặt phòng trực tuyến giá tốt nhất.{/if}" />
		<meta name="twitter:image" content="{$logo_url|escape:'html':'UTF-8'}" />
		...
		{block name='displayHeader'}
			{$HOOK_HEADER}
		{/block}
		<link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@400;500;600;700;800&amp;display=swap" type="text/css" media="all" />
